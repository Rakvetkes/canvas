package org.aki.helvetti.inversion;
...
public final class CBlockInversionManager {
    ...
    public static void registerFlippingList() {
        FLIPPING_LIST.put(Blocks.GRASS_BLOCK.defaultBlockState(), CCanvasBlocks.FLIPPED_GRASS_BLOCK.get().defaultBlockState());
    }
